    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-4">
        {cards.map((card) => (
          <div
            key={card.title}
            className={`p-4 rounded-md shadow ${card.color} flex items-center justify-between`}
          >
            <div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-md shadow">
          ...
          <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
            <li>
              ...
              <br />
              <span className="text-xs text-gray-500">Today 12:00 PM</span>
            </li>
            <li>
              📄 New document <b>Annual Budget</b> from Head of Adult Lending.
              <br />
              <span className="text-xs text-gray-500">Yesterday 2:40 PM</span>
            </li>
            <li>
              📄 You sent <b>Training Schedule.docx</b> to District Librarian.
              <br />
              <span className="text-xs text-gray-500">Monday 10:20 AM</span>
            </li>
          </ul>
        </div>
      </div>
